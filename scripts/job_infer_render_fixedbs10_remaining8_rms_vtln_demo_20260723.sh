...
LOG_DIR="${WORKSPACE_ROOT}/Inversion_SI/logs/asd2_fixedbs10_remaining8_rms_vtln_demo_20260723"
...
for pair in "2 9" "3 14" "4 4" "5 6" "6 8" "8 2" "9 5" "10 14"; do
    read -r speaker session <<< "${pair}"
    echo "START P${speaker}/S${session}"
